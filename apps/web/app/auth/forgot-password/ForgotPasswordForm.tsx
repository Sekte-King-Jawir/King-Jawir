  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      <div className="w-full max-w-md p-8 rounded-xl bg-background border border-gray-200 dark:border-gray-700 shadow-md dark:shadow-lg">
        <h1 className="text-2xl font-bold text-center mb-2 text-foreground">Lupa Password</h1>
        <p className="text-center text-gray-500 mb-6 text-sm">Masukkan email Anda untuk menerima link reset password</p>
