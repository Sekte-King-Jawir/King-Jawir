    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <Link href="/auth/login" className="text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors">
                Masuk
              </Link>
              <Link href="/auth/register" className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors">
                Daftar Gratis
              </Link>
            </div>
          </div>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto mb-10">
            Bandingkan harga produk Anda dengan kompetitor di Tokopedia secara real-time. 
            Dapatkan rekomendasi harga optimal dari AI untuk meningkatkan daya saing bisnis Anda.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/price-analysis" className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold text-lg transition-all hover:scale-105 shadow-lg shadow-blue-600/30">
              🚀 Mulai Analisis Harga
            </Link>
            <Link href="/products" className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-xl font-semibold text-lg border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-600 transition-all">
              📦 Lihat Marketplace
            </Link>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-white dark:bg-slate-800 rounded-2xl shadow-sm hover:shadow-lg transition-shadow border border-slate-100 dark:border-slate-700">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Ambil data harga kompetitor dari Tokopedia secara otomatis dan real-time untuk produk sejenis.
              </p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-slate-800 rounded-2xl shadow-sm hover:shadow-lg transition-shadow border border-slate-100 dark:border-slate-700">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                AI menganalisis data pasar dan memberikan rekomendasi harga optimal berdasarkan statistik kompetitor.
              </p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-slate-800 rounded-2xl shadow-sm hover:shadow-lg transition-shadow border border-slate-100 dark:border-slate-700">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Dapatkan insight tentang posisi harga Anda di pasar, apakah terlalu mahal, murah, atau sudah kompetitif.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
            Mulai analisis harga sekarang dan temukan strategi pricing yang optimal untuk produk Anda.
          </p>
          <Link href="/price-analysis" className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold text-lg transition-all hover:scale-105 shadow-lg shadow-blue-600/30">
      ...
      <footer className="py-8 px-4 border-t border-slate-200 dark:border-slate-700 bg-white/50 dark:bg-slate-800/50">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <Link href="/products" className="text-sm text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400">
              Marketplace
            </Link>
            <Link href="/price-analysis" className="text-sm text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400">
              Price Analysis
            </Link>
          </div>
        </div>
