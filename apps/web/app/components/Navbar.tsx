      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 lg:h-20 items-center justify-between gap-4">
          ...
          <div className="hidden md:flex flex-1 max-w-xl mx-4">
            <div className="relative w-full group">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <svg className="w-5 h-5 text-gray-400 group-focus-within:text-violet-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            <Link href="/" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-violet-600 hover:bg-violet-50 rounded-xl transition-all">
              Home
            </Link>
            <Link href="/product" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-violet-600 hover:bg-violet-50 rounded-xl transition-all">
              Produk
            </Link>
            <Link href="/category" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-violet-600 hover:bg-violet-50 rounded-xl transition-all">
              Kategori
            </Link>
            <Link href="/promo" className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-rose-500 to-pink-500 rounded-xl hover:shadow-lg hover:shadow-rose-500/30 hover:-translate-y-0.5 transition-all">
              🔥 Promo
            </Link>
          </nav>
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Wishlist */}
            <Link href="/favourites" className="relative p-2.5 text-gray-600 hover:text-violet-600 hover:bg-violet-50 rounded-xl transition-all hidden sm:flex">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Cart */}
            <Link href="/cart" className="relative p-2.5 text-gray-600 hover:text-violet-600 hover:bg-violet-50 rounded-xl transition-all">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-gray-50 border-t border-gray-100">
          <div className="max-w-7xl mx-auto px-4 py-4 space-y-3">
            ...
            <nav className="grid grid-cols-2 gap-2">
              ...
              >
                <span className="w-10 h-10 bg-violet-100 rounded-lg flex items-center justify-center">🏠</span>
