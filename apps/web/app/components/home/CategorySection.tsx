...
const defaultCategories = [
  { icon: '📱', label: 'Phones', slug: 'phones', count: 24, gradient: 'from-blue-500 to-cyan-500', bgColor: 'bg-blue-50' },
  { icon: '⌚', label: 'Smart Watches', slug: 'smart-watches', count: 18, gradient: 'from-purple-500 to-pink-500', bgColor: 'bg-purple-50' },
  { icon: '📷', label: 'Cameras', slug: 'cameras', count: 12, gradient: 'from-orange-500 to-red-500', bgColor: 'bg-orange-50' },
  { icon: '🎧', label: 'Headphones', slug: 'headphones', count: 32, gradient: 'from-rose-500 to-pink-500', bgColor: 'bg-rose-50' },
  { icon: '💻', label: 'Computers', slug: 'computers', count: 45, gradient: 'from-gray-600 to-gray-800', bgColor: 'bg-gray-100' },
  { icon: '🎮', label: 'Gaming', slug: 'gaming', count: 28, gradient: 'from-indigo-500 to-purple-500', bgColor: 'bg-indigo-50' },
]
        ...
        >
          {displayCategories.map((category, index) => (
            ...
            >
              ...
              >
                {/* Background */}
                <div className={`absolute inset-0 ${category.bgColor} transition-all duration-300`} />
